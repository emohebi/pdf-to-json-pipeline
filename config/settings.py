...
UOM_EXTRACTION_DIR = INTERMEDIATE_DIR / "uom_extraction"
BATCHES_DIR = INTERMEDIATE_DIR / "section_Batches"
for d in (DETECTION_DIR, SECTIONS_DIR, VALIDATION_QUEUE_DIR, IMG_DESC_DIR, TERM_MATCHING_DIR, EFFECTIVE_DATE_DIR, UOM_EXTRACTION_DIR, BATCHES_DIR):
    d.mkdir(parents=True, exist_ok=True)
